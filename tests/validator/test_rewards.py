...
def test_get_rewards():
    ...
    mock_yt_stats = [
        ...
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 10, "brief2": 10, "brief3": 10}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 10}, "matching_brief_ids": ["brief1", "brief2", "brief3"], "decision_details": {"video_vet_result": True}}
        }},
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 15, "brief2": 15, "brief3": 15}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 20}, "matching_brief_ids": ["brief1", "brief2", "brief3"], "decision_details": {"video_vet_result": True}}
        }}
    ]
...
def test_get_rewards_with_zeros():
    ...
    mock_yt_stats = [
        ...
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 0, "brief2": 10, "brief3": 10}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 10}, "matching_brief_ids": ["brief2", "brief3"], "decision_details": {"video_vet_result": True}}
        }},  # Scores for response 1
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 10, "brief2": 0, "brief3": 10}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 10}, "matching_brief_ids": ["brief1", "brief3"], "decision_details": {"video_vet_result": True}}
        }},  # Scores for response 2
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 10, "brief2": 10, "brief3": 0}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 10}, "matching_brief_ids": ["brief1", "brief2"], "decision_details": {"video_vet_result": True}}
        }}   # Scores for response 3
    ]
...
def test_normalise_scores():
    ...
    mock_yt_stats = [
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 0, "brief2": 0}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 0}, "matching_brief_ids": ["brief1", "brief2"], "decision_details": {"video_vet_result": True}}
        }},
        {"yt_account": {"channel_vet_result": True}, "scores": {"brief1": 0, "brief2": 0}, "videos": {
            "video1": {"analytics": {"estimatedMinutesWatched": 0}, "matching_brief_ids": ["brief1", "brief2"], "decision_details": {"video_vet_result": True}}
        }}
