...
YT_LIFETIME_DEDUCTION = float(os.getenv('YT_LIFETIME_DEDUCTION', '100'))
YT_LIFETIME_DEDUCTION_AD_READ = float(os.getenv('YT_LIFETIME_DEDUCTION_AD_READ', '25'))
...
# acceptance filter
YT_MIN_ALPHA_STAKE_THRESHOLD = int(os.getenv('YT_MIN_ALPHA_STAKE_THRESHOLD', '1000'))
