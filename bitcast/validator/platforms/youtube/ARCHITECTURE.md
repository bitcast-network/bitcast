...
YT_LOOKBACK = 90                                    # Days to search for videos
YT_ROLLING_WINDOW = 7                               # Score calculation window
YT_REWARD_DELAY = 3                                 # Days between publish and reward eligibility
YT_VIDEO_RELEASE_BUFFER = 3                        # Buffer for brief timing validation
YT_MAX_VIDEOS = 50                                  # Maximum videos per evaluation
YT_MAX_VIDEOS_PER_DEDICATED_BRIEF = 2               # Limit for dedicated brief types

# Channel & Video Thresholds  
YT_MIN_SUBS = 100                                   # Minimum subscriber requirement
YT_MIN_CHANNEL_AGE = 21                            # Minimum channel age (days)
YT_MIN_CHANNEL_RETENTION = 0.10                    # Minimum channel retention rate
YT_MIN_VIDEO_RETENTION = 0.10                      # Minimum video retention rate

# Scoring & Rewards
YT_SCALING_FACTOR_DEDICATED = 2000                  # Scaling for dedicated content
YT_SCALING_FACTOR_PRE_ROLL = 400                   # Scaling for pre-roll content  
YT_SMOOTHING_FACTOR = 0.6                          # Score smoothing factor
YT_MIN_EMISSIONS = 0                               # Minimum emission threshold

# Anti-Exploitation Protection
YT_SCORE_CAP_START_DAYS = 60                       # Start of median calculation period
YT_SCORE_CAP_END_DAYS = 30                         # End of median calculation period

# Performance & Security
ECO_MODE = True                                     # Early exit optimizations
MAX_ACCOUNTS_PER_SYNAPSE = 3                       # Account processing limit
YT_MIN_ALPHA_STAKE_THRESHOLD = 1000                # Non-YPP minimum stake requirement
```
...
CACHE_DIRS = {
    "openai": "cache/openai",                       # OpenAI response caching
    "briefs": "cache/briefs",                       # Brief data caching
    "blacklist": "cache/blacklist",                 # Blacklist data caching
    "youtube_search": "cache/youtube_search",       # Search result caching
    "views_revenue_ratio": "cache/views_revenue_ratio"  # Ratio caching
}
